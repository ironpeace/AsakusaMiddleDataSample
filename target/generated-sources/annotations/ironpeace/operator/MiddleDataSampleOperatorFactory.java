...
@Generated("OperatorFactoryClassGenerator:0.0.1") public class MiddleDataSampleOperatorFactory {
    ...
    /**
     */
    public static final class ConvertToMid2FromMid3 implements Operator {
        private final FlowElementResolver $;
        /**
         * 入力された内容
         */
        public final Source<Middata3> original;
        /**
         */
        public final Source<Middata2> out;
        ConvertToMid2FromMid3(Source<Middata3> mid3) {
            OperatorDescription.Builder builder0 = new OperatorDescription.Builder(Convert.class);
            builder0.declare(MiddleDataSampleOperator.class, MiddleDataSampleOperatorImpl.class, "convertToMid2FromMid3"
                    );
            builder0.declareParameter(Middata3.class);
            builder0.addInput("mid3", mid3);
            builder0.addOutput("original", mid3);
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public MiddleDataSampleOperatorFactory.ConvertToMid2FromMid3 as(String newName0) {
     ...
     * @param mid3
     * @return 生成した演算子オブジェクト
     * @see MiddleDataSampleOperator#convertToMid2FromMid3(Middata3)
     */
    public MiddleDataSampleOperatorFactory.ConvertToMid2FromMid3 convertToMid2FromMid3(Source<Middata3> mid3) {
        return new MiddleDataSampleOperatorFactory.ConvertToMid2FromMid3(mid3);
    }
    /**
     */
    ...
    public static final class JoinOriginalAndMid implements Operator {
        ...
        JoinOriginalAndMid(Source<OriginalData> orignal, Source<Middata> mid) {
            ...
            builder2.declare(MiddleDataSampleOperator.class, MiddleDataSampleOperatorImpl.class, "joinOriginalAndMid");
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public MiddleDataSampleOperatorFactory.JoinOriginalAndMid as(String newName2) {
    ...
    public static final class JoinMid3AndMid2 implements Operator {
        ...
        JoinMid3AndMid2(Source<Middata3> mid3, Source<Middata2> mid2) {
            ...
            builder3.declare(MiddleDataSampleOperator.class, MiddleDataSampleOperatorImpl.class, "joinMid3AndMid2");
         ...
         * @throws IllegalArgumentException 引数に{@code null}が指定された場合
         */
        public MiddleDataSampleOperatorFactory.JoinMid3AndMid2 as(String newName3) {

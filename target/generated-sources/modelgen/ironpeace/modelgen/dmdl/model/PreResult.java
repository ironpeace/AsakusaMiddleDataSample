...
import ironpeace.modelgen.dmdl.io.PreResultInput;
import ironpeace.modelgen.dmdl.io.PreResultOutput;
 ...
 */
@DataModelKind("DMDL")@Joined(terms = {@Joined.Term(source = Middata3.class, mappings = {@Joined.Mapping(source = 
                ...
                ),@Joined.Mapping(source = "mid1", destination = "mid1"),@Joined.Mapping(source = "mid2", destination = 
                "mid2")}, shuffle = @Key(group = {"keycode"})),@Joined.Term(source = Middata2.class, mappings = {@Joined
                .Mapping(source = "keycode", destination = "keycode"),@Joined.Mapping(source = "alert1", destination = 
                "alert1"),@Joined.Mapping(source = "alert2", destination = "alert2")}, shuffle = @Key(group = {"keycode"
            }))})@ModelInputLocation(PreResultInput.class)@ModelOutputLocation(PreResultOutput.class)@PropertyOrder({
            "keycode", "data1", "data2", "data3", "mid1", "mid2", "alert1", "alert2"}) public class PreResult implements 
        DataModel<PreResult>, Writable {

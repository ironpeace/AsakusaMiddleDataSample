...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/mdsBatch/TheMiddataSampleJobFlow/stage0001";
    }
    ...
    @Override protected List<StageOutput> getStageOutputs() {
        ...
        results.add(new StageOutput("result0", NullWritable.class, Middata3.class, TemporaryOutputFormat.class));
        return results;
    }

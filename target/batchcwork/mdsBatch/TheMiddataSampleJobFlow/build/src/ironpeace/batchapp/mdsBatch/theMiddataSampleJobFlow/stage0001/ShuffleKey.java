...
@SuppressWarnings("deprecation") public final class ShuffleKey implements SegmentedWritable {
    ...
    /**
     * MiddleDataSampleOperator.joinOriginalAndMid#orignalが利用するキー (keycode)
     */
    public IntOption groupElem0Term1 = new IntOption();
    /**
     * MiddleDataSampleOperator.joinOriginalAndMid#orignalのキーの元になるモデルオブジェクトを設定する
    ...
    /**
     * MiddleDataSampleOperator.joinOriginalAndMid#midのキーの元になるモデルオブジェクトを設定する
     * @param source 設定するモデルオブジェクト
     */
    public void setPort2(Middata source) {
        this.portId = 2;
        this.groupElem0Term1.copyFrom(source.getKeycodeOption());
    }
    /**
